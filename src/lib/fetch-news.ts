...
const SUPABASE_URL = process.env.SUPABASE_URL || 'https://dbyqvtfqgutqiuglcsmd.supabase.co';
const SUPABASE_KEY = process.env.SUPABASE_ANON_KEY || 'sb_publishable__d2nTNNx6bCo2wyfJNNJ-w_ISKmXmkx';
